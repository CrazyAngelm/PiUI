...
if (!sessionPersistenceFeedback.includes('SESSION_PERSISTENCE_FEEDBACK_DELAY_MS') || !sessionPersistenceFeedback.includes('didResolveNewSession') || !sessionPersistenceFeedback.includes('withoutPersistedLiveBlocks')) throw new Error('New-session persistence feedback must tolerate delayed catalog discovery without dropping queued output.');
