...
2. Откройте [релиз PiUI v0.1.1](https://github.com/CrazyAngelm/PiUI/releases/tag/v0.1.1).
3. Скачайте `PiUI_0.1.1_x64-setup.exe` и соответствующий файл `SHA256SUMS.txt`.
...
Портативный файл `PiUI_0.1.1_windows_x86_64.exe` можно использовать без установки. На него распространяются те же ограничения preview-версии.
